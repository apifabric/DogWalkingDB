...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.WalkLog, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.SpecialInstruction, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.WalkService, method_decorators= method_decorators)
    return api
