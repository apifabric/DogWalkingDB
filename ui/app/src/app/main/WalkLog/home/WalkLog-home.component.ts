...
@Component({
  selector: 'WalkLog-home',
  templateUrl: './WalkLog-home.component.html',
  styleUrls: ['./WalkLog-home.component.scss']
})
export class WalkLogHomeComponent implements AfterViewInit {
