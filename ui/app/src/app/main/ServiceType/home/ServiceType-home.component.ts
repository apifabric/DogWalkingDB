...
@Component({
  selector: 'ServiceType-home',
  templateUrl: './ServiceType-home.component.html',
  styleUrls: ['./ServiceType-home.component.scss']
})
export class ServiceTypeHomeComponent implements AfterViewInit {
