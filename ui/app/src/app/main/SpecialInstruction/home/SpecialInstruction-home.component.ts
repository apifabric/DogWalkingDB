...
@Component({
  selector: 'SpecialInstruction-home',
  templateUrl: './SpecialInstruction-home.component.html',
  styleUrls: ['./SpecialInstruction-home.component.scss']
})
export class SpecialInstructionHomeComponent implements AfterViewInit {
